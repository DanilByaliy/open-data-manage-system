...
[Source-код RESTfull сервісу](https://github.com/DanilByaliy/open-data-manage-system/tree/master/src/js)
...
- `/role` - (get) - Отримати список всіх ролей
- `/role` - (post) - Створити роль
- `/role/:id` - (get) - Отримати одину роль за ID
- `/role/:id` - (patch) - Оновити роль за ID
- `/role/:id` - (delete) - Видалити роль за ID

- `/availableaction` - (get) - Отримати список всіх зв'язків між ролями і типами дій
- `/availableaction` - (post) - Створити один такий зв'язок
- `/availableaction/:id` - (get) - Отримати зв'язок за його ID
- `/availableaction/:id` - (patch) - Оновити зв'язок за його ID
- `/availableaction/:id` - (delete) - Видалити зв'язок за його ID
